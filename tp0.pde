...
void setup(){
 ...
 void draw(){
  ...
  fill(255, 125, 154); //Color Fondo
  rect(25, 50, 550 ,500); //Cuadrado Fondo
  fill(255, 102, 142); //Color rectangulo
  rect(25, 50, 550 ,35); //Rectangulp
  rect(25, 150, 550 ,35); //Rectangulp
  rect(25, 250, 550 ,35); //Rectangulp
  rect(25, 350, 550 ,35); //Rectangulp
  rect(25, 452, 550 ,35); //Rectangulp
  rect(25, 550, 550 ,35); //Rectangulp
